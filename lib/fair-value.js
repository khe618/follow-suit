...
// Spec 4.6. From one player's view the unseen part of the deck U (the other
// hands) is a uniform (P-1)*n-subset of (pool - hand); the deck D = H + U is
// flipped in uniform order.
